...
setup(
    ...
    packages=find_packages(
        include=[
            'youtube', 
            'youtube.resources',
            'youtube.resources.youtube_channel',
            'youtube.resources.youtube_comment',
            'youtube.resources.youtube_comment_thread',
            'youtube.resources.youtube_playlist',
            'youtube.resources.youtube_video',
            'youtube.resources.youtube_video_category',
            'youtube.oauth',
            'youtube.exceptions',
            'youtube.search',
